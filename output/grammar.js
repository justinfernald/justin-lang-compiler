...
var grammar = {
    ...
    {"name": "varDecl", "symbols": ["typeSpec", "varDeclId", (lexer.has("scolon") ? {type: "scolon"} : scolon)], "postprocess": (data) => ({type: "varDecl", rule: 0, ...ast(data), symbol: symbol(data[0], data[1], ...data)})},
    ...
    {"name": "iterStmt", "symbols": [(lexer.has("forr") ? {type: "forr"} : forr), (lexer.has("lparan") ? {type: "lparan"} : lparan), "scopedVarDecl", "simpleExp", (lexer.has("scolon") ? {type: "scolon"} : scolon), "exp", (lexer.has("rparan") ? {type: "rparan"} : rparan), "stmt"], "postprocess": (data) => ({type: "iterStmt", rule: 1, ...ast(data, true, "for")})},
