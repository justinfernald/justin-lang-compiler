import { getContext, indexer } from "./utils";
    ...
    semanticCheckDFS = (node) => {
        ...
        switch (node.type) {
            ...
            case "funcDecl": {
                ...
                this.currentFunction = currentScope().symbols[currentScope().symbols.length - 1];
                break;
            }
            case "scopedVarDecl": {
                if (indexer(node, 1, 0).rule === 0) {
