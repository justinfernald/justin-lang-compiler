...
var grammar = {
    ...
    {"name": "localDecls", "symbols": ["localDecls", "scopedVarDecl"], "postprocess": (data) => ({type: "localDecls", rule: 0, ...ast(data)})},
    {"name": "localDecls", "symbols": [], "postprocess": (data) => ({type: "localDecls", rule: 1, ...ast(data)})},
